-- Update get_market_dashboard function to include news data for stock detail
...
BEGIN
  IF stock_ticker IS NOT NULL THEN
    -- Individual stock detail with comprehensive chart data and news
    ...
    FROM stock_detail sd, stock_news sn;
  ELSE
